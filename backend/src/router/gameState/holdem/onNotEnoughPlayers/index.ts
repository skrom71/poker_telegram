...
import { zOnNotEnoughPlayersTrpcInput } from './input'

export const onNotEnoughPlayersTrpcRoute = trpc.procedure
  .input(zOnNotEnoughPlayersTrpcInput)
  .subscription(({ input }) => {
    const event = 'onNotEnoughPlayers'
