...
import { zOnPlayersWinTrpcInput } from './input'

export const onPlayersWinTrpcRoute = trpc.procedure.input(zOnPlayersWinTrpcInput).subscription(({ input }) => {
  const event = 'onPlayersWin'
